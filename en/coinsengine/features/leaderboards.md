...
:::note
You can remove players from the leaderboards by giving them `coinsengine.hidefromtops` [permission](../permissions.md).
...
You can disable leaderboard for certain [currencies](currencies.md) in their config files:
