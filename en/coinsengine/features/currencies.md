...
* [Cross-Server Setup](cross-server.md)
* [Vault Integration](../hooks/vault.md)
...
To remove a currency, simply delete it's config file from the `/currencies/` directory and [reload](../commands.md) the plugin.
