...
To set currency prefix, edit the `Prefix` value in [currency config](currencies.md). This value is used to replace the `%currency_prefix%` placeholder in the format above.
