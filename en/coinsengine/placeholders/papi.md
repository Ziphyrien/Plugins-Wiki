...
:::caution
Replace `[currency]` with a [Currency ID](../features/currencies.md#currency-id).
:::
...
:::caution
You must enable the [Leaderboards](../features/leaderboards.md) for these placeholders to work.
:::
